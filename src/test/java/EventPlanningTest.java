...
public void EventPlanning_instantiatesCorrectly() {
  EventPlanning testEventPlanning = new EventPlanning(25,"grand", "limebeer", "Rock", "Magic Shoes");
...
@Test
        public void EventPlanning_calculateFoodPrice_10() {
          EventPlanning testEventPlanning = new EventPlanning(10,"grand", "limebeer", "Rock", "Magic Shoes");
          assertEquals(500, testEventPlanning.calculateFoodPrice());
        }

@Test
        public void EventPlanning_calculateFoodPrice_4500() {
          EventPlanning testEventPlanning = new EventPlanning(100,"grand", "limebeer", "Rock", "Magic Shoes");
...
@Test
        public void EventPlanning_calculateFoodPrice_10500() {
          EventPlanning testEventPlanning = new EventPlanning(300,"grand", "limebeer", "Rock", "Magic Shoes");
...
@Test
    public void EventPlanning_calculateFoodPrice_15000() {
      EventPlanning testEventPlanning = new EventPlanning(600,"grand", "limebeer", "Rock", "Magic Shoes");
      assertEquals(15000, testEventPlanning.calculateFoodPrice());
    }

@Test
        public void EventPlanning_calculateFoodPrice_1000() {
          EventPlanning testEventPlanning = new EventPlanning(50,"simple", "limebeer", "Rock", "Magic Shoes");
          assertEquals(1000, testEventPlanning.calculateFoodPrice());
        }


        @Test
                public void EventPlanning_calculateFoodPrice_2000() {
                  EventPlanning testEventPlanning = new EventPlanning(200,"simple", "limebeer", "Rock", "Magic Shoes");
